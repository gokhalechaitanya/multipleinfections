...
Intuitively, if parasites are uncooperative in both reproduction and manipulation, they can not persist. 
In contrast, if they are highly cooperative in both aspects, that is, reproduction and manipulation in double infections are much higher than in single infection, there is one guaranteed single equilibrium for parasite existence. 
For intermediate cooperation of both reproduction and manipulation, there exist the area of bistability, whose size is sensitive to the reproduction value in single infection. In particular, a higher value of reproduction on single infection lead to smaller bistability area.
If the parasites only sabotage host manipulation, the system is highly prone to bistability, and only has a single equilibrium when cooperation in reproduction is extremely high (i.e. reproduction in double infections is much higher than reproduction in single infection).
Interestingly, noncooperative in reproduction always lead to single equilibrium of the system (Figure \ref{fig:manipbifur}). 
Bistability area indicates that a disturbance of the system may likely lead to extinction of parasite. 
This suggests that, if the reproduction in single infection is sufficiently small, systems in which parasites cooperate in both reproduction and manipulation may be more vulnerable to extinction than systems with less cooperative parasites. 

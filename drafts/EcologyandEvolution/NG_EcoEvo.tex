...
\cha{Interactions between parasites need not be limited to host manipulation. }
Parasites can have an enhanced reproduction rate in co-infections, i.e. $f_{ww} > f_w$. 
...
%On the other hand, coordinating in one aspect or insufficient cooperation in both aspects may make the parasite population more vulnerable to extinction than systems with less cooperative parasites.

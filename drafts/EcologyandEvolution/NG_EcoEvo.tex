...
\begin{figure}[!ht]
	...
	\caption{\cha{Left: Right: }Common parameters:  $\rho = 1.2, \ d = 0.9, \ r = 2.5, \ \gamma = 2.9, \ \alpha_w = 0, \ \alpha_{ww} = 0, \ p = 0.05, \ c = 1.4, \ \mu = 3.9, \ \sigma_w = 0, \ \sigma_ww = 0, \ q = 0.05, \ \delta = 0.9, \ k = 0.26, \ \epsilon = 4.5, \ \beta_w = 1.3, \ f_w = 35, \ h_1 = h_2 = 0.6$.}
...
% In other words, it is a way of destabilising the predator-prey system.%, different from the result of \cite{Rogawa2018}. 

...
We analyse the effect of host manipulation on the ecological dynamics of the prey-predator-parasite system, considering manipulation when multiple infections occur. We found that cooperation in host manipulation leads to bistability in the predator-pray system, given that reproduction from multiple infection is sufficiently high. This suggests that disturbance in the system may result in parasite extinction. 
...
$P_s, \ P_w, \ P_{ww}$ are the predation functions of respectively definitive hosts on susceptible, singly infected and doubly infected intermediate hosts. 

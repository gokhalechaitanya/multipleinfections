...
It should be noted that, in nature, complex life-cycle parasites can have more than two hosts. However, our model consists of a single intermediate host as it already provides enough complexity to discuss between transmission and manipulation.

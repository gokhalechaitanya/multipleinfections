...
This assumption is motivated given that the prey lifecycle is often shorter than the predator's. 
...
However, there are always limitations and trade-offs, so high values may only be possible sometimes.

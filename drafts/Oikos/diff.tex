...
%DIF ADD Oikos_main.tex               Wed Mar  6 15:49:15 2024
...
\citep{Parker2003,Vickery2009}}\hskip0pt%DIFAUXCMD
.
Moreover, these mdoels }\DIFaddend assume that transmission from definitive hosts to intermediate hosts is due to direct contact between the two types of hosts \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Rogawa2018, Iritani2018, Hadeler1989, Fenton2006}}\hskip0pt%DIFAUXCMD
}\DIFaddend . 
This is often not the case \DIFaddbegin \DIFadd{in nature}\DIFaddend , as parasites are released from the definitive hosts into the environment. Transmission \DIFaddbegin \DIFadd{thus }\DIFaddend happens only when intermediate hosts have contact with this free-living parasite pool. \DIFaddbegin \DIFadd{The inclusion of this free-living stage could induce profound effect on the dynamics of the whole predator-prey-parasite system.

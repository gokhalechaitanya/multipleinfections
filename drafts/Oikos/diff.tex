...
%DIF ADD main.tex                            Wed Nov 13 12:36:05 2024
...
\DIFaddbeginFL \DIFaddFL{While this is a specific example of a parasite with a complex lifecycle, our model abstracts the concept to generic multi-host lifecycles with an environmental component.
}\DIFaddendFL }
\label{fig:empirical}
\end{figure}
...
\hline
$p$ & Probability that two parasites cotransmit from the environment to an intermediate host  \DIFaddbeginFL & \DIFaddFL{dimensionless}\DIFaddendFL \\
\hline
...
\hline
$\sigma_i$ & Additional death rate of the hosts due to being infected by a singly parasite ($i = w$) or two parasites ($i = ww$) \DIFaddbeginFL & \DIFaddFL{$t^{-1}$}\DIFaddendFL \\
\hline
$q$ & Probability that two parasites cotransmit from intermediate hosts to definitive hosts \DIFaddbeginFL & \DIFaddFL{dimensionless }\DIFaddendFL \\
\hline
...
Finally, comparing conditions of host (parameters $\alpha_w$, $\alpha_{ww}$, $\sigma_w$, and $\sigma_{ww}$) between no infection, single and multiple infections illustrates the magnitude of parasite virulence. 

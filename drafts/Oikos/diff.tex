...
%DIF ADD main.tex                                Tue Jun 25 13:53:52 2024
...
\DIFaddbegin \DIFadd{Figure (\ref{fig:schematic}) illustrates the transmission dynamics, and details of the model's variables and parameters are shown in Table \ref{table:varpardescription}.
...
.
}\DIFaddend Given that infection occurs, the probability that two parasites from the parasite pool co-transmit to an intermediate host is denoted by $p$. 
...
A) \DIFdelbeginFL \DIFdelFL{Enhanced }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A bifurcation graph for different values of }\DIFaddendFL reproduction in \DIFdelbeginFL \DIFdelFL{double }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{single }\DIFaddendFL infection \DIFdelbeginFL \DIFdelFL{leads to bistability, }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{and double infections. }\DIFaddendFL B\DIFdelbeginFL \DIFdelFL{, C}\DIFdelendFL ) \DIFdelbeginFL \DIFdelFL{Density }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Equilibrium values }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{singly infected }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{intermediate }\DIFaddendFL host \DIFdelbeginFL \DIFdelFL{at equilibrium }\DIFdelendFL when \DIFdelbeginFL \DIFdelFL{reproduction }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\epsilon = 4$ when bistability occur at high values }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{parasites are the same }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$f_w$ (}\DIFaddendFL in \DIFdelbeginFL \DIFdelFL{singly and doubly infected hosts $f_{ww} = f_w$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{pink)}\DIFaddendFL , and \DIFaddbeginFL \DIFaddFL{$\epsilon = 4$ }\DIFaddendFL when \DIFdelbeginFL \DIFdelFL{reproduction }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{only one stable equilibrium exist at high values }\DIFaddendFL of \DIFaddbeginFL \DIFaddFL{$f_w$ (in purple). 
C) Details of the }\DIFaddendFL parasites \DIFaddbeginFL \DIFaddFL{population dynamics }\DIFaddendFL in \DIFdelbeginFL \DIFdelFL{doubly }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the case of bistability shown through the }\DIFaddendFL infected \DIFaddbeginFL \DIFaddFL{intermediate }\DIFaddendFL hosts\DIFdelbeginFL \DIFdelFL{is enhanced four times than those in singly infected hosts $f_{ww} = 4 f_w$}\DIFdelendFL . 
\DIFaddbeginFL \DIFaddFL{When the parasites start at high density, the parasite population persists whereas when they start at lower density, the parasite population perishes.
}\DIFaddendFL Filled circles indicate stable equilibrium and open circles indicate unstable equilibrium. Parameter $\rho = 1.2, \  d = 0.9, \  r = 2.5, \ \gamma = 2.9, \ \alpha_w = 0, \ \alpha_{ww} =  0, \ \beta_w = 1.5, \ \beta_{ww} = 1.5, \ p = 0.05, \  c = 1.4, \ \mu = 3.9,  \ \sigma_w = 0, \ \sigma_{ww} = 0, \  q = 0.05, \ \delta = 0.9, \ k = 0.26, \ h = 0.6$.
}

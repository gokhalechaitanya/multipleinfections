...
%DIF DEL old/Oikos_submittedversion_round1.tex   Wed Jun  5 14:40:10 2024
%DIF ADD main.tex                                Fri Jun 28 19:12:58 2024
...
If coinfected parasites are discordant, i.e. uncooperative in manipulations and show suppressed reproduction, they cannot persist (Figure \ref{fig:manipbifur}\DIFaddbegin \DIFadd{A-D}\DIFaddend ). 
...
\DIFdelbegin \DIFdel{Very often , we }\DIFdelend \DIFaddbegin \DIFadd{We often }\DIFaddend expect intermediate levels of coordination where a bistable area could occur (top left quadrant in Figure \ref{fig:manipbifur}\DIFdelbegin \DIFdel{at $f_w = (37, 37.5)$}\DIFdelend \DIFaddbegin \DIFadd{A, C, D}\DIFaddend ).
However, the size of this area is sensitive to the value of reproduction and manipulation in a single infection. 
In particular, higher values of these two parameters reduce the bistability area \DIFdelbegin \DIFdel{to the point }\DIFdelend \DIFaddbegin \DIFadd{so }\DIFaddend that sufficiently large reproduction in \DIFaddbegin \DIFadd{a }\DIFaddend single infection can guarantee single equilibrium when parasites coordinate (\DIFdelbegin \DIFdel{top left quadrant in Figure \ref{fig:manipbifur} Left at $f_w = (38)$, Figure SI.2 }\DIFdelend \DIFaddbegin \DIFadd{Figure \ref{fig:manipbifur} B}\DIFaddend ).

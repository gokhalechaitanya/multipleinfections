...
\centering
\includegraphics[width=0.8\columnwidth]{Figures/cartoon2.pdf}
...
While this is a specific example of a parasite with a complex lifecycle, our model abstracts the concept to generic multi-host lifecycles with an environmental component.
}
\label{fig:empirical}
\end{figure}
...
\centering
\captionsetup{format=plain}
\includegraphics[width=0.85\textwidth]{Figures/ecotraject_nonlinear.pdf}

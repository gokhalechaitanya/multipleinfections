...
In addition, we consider multiple infection of the same parasite species.
Although in nature, a host can be co-infected by multiple parasites of the same or different species, results of our model stay valid as the key aspect in host manipulation is the alignment or conflict of interest between co-infecting parasites.

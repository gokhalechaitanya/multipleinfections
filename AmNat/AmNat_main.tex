...
Interestingly, the higher the cooperation in both manipulation and reproduction, the larger the area of bistability (Figure \ref{fig:manipbifur}). This suggests that systems, in which parasites have much higher manipulative ability and reproduction rate when coinfected than when singly infected, are more unstable than systems with parasites that are less cooperative, or systems with parasites that sabotage each other in coinfection. In other words, having the best of both words at the individual level may not benefit the population as a whole.
